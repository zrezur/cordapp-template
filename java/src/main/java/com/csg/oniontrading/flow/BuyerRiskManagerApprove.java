 ...
 */
public class BuyerRiskManagerApprove extends FlowLogic<TradingFlowResult> {

    //        private final Party issuer;
    private String approverName = "someBuyerRiskManagerApprove";
    private TradingState tradingState;

    public BuyerRiskManagerApprove(TradingState tradingState) {
//            this.issuer = issuer;
    ...
    public TradingFlowResult call() {
        ...
        send(tradingState.getSeller(), signedTransaction);
